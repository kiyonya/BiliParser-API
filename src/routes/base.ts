...
export class BaseRoute extends APIRoute {
    ...
    public override async handle(ctx: AppContext) {
        ...
        const demoUrls: Record<string, string> = {
            "video play": `${demoUrl}/video/BV1UT42167xb`,
            "video part": `${demoUrl}/video/BV1LCzTByEBY/2`,
            "video info": `${demoUrl}/video/BV1UT42167xb?type=json`,
            "video cover": `${demoUrl}/cover/BV1UT42167xb`,
            ...
            "danmaku xml": ` ${demoUrl}/danmaku/BV1UT42167xb`,
            "danmaku json": ` ${demoUrl}/danmaku/BV1UT42167xb?type=json`,
